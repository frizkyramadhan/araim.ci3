					...
					<div class="box-content">
						  ...
						  <fieldset>
							<div class="control-group">
							  ...
							  <div class="controls">
                                                              <input type="text" class="span6" name="nama_jabatan" value="<?php echo $jabatan->nama_jabatan?>"/>
							  </div>
							</div>
							<div class="control-group">
							  <label class="control-label">Department</label>
							  <div class="controls">
                                                              <?=form_dropdown('id_dept',$options,$selected,'class="span6" id="selectError" data-rel="chosen"');?>
							  </div>
							</div>
