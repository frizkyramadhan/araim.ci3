                                                        ...
                                                        <table class="table table-striped table-bordered table-condensed bootstrap-datatable datatable">
                                                            ...
                                                            <tbody>
                                                                <tr>																	<?php $i=1;?>
																	...
																	<td><?php echo $row->tanggal; ?></td>																<td><?php echo $row->nama_aset; ?></td>
                                                                    <td><?php echo $row->merk; echo " / ";echo $row->model; ?></td>
                                                                    <td><?php echo $row->sn; echo " / ";echo $row->pn; ?></td>
                                                                    <td><?php echo $row->po; ?></td>
																	<td><?php echo $row->ref_no; ?></td>
																	<td><?php echo $row->ref_date; ?></td>
                                                                    <td><?php echo $row->remarks;?></td>																	<td><div align="center">
                                                        ...
                                                        <div class="row-fluid">
                                                            <div class="box span4" onTablet="span6" onDesktop="span4">
                                                                    ...
                                                                    <div class="box-content">
                                                                        ...
                                                                        <input name="data[<?php echo $i ?>][no_inv]" value="<?php echo $y; echo $m;?><?php echo str_pad($no_inv++, 6, "0", STR_PAD_LEFT)?>" type="hidden"/>
                                                                            ...
                                                                            <div class="control-group">
																			  ...
																			  <div class="control-group">
                                                                                ...
                                                                                <div class="controls-widget">
                                                                                    <input type="text" name="data[<?php echo $i ?>][lokasi]" class="span12" placeholder="Detail Location" value="<?php echo set_value("data[$i][lokasi]");?>"/>
