									...
									<table class="table table-striped table-bordered table-condensed bootstrap-datatable datatable">
                                        ...
                                        <tbody>
											<tr>
                                                ...
                                                <td><?php $count = $this->db->query("select * from perbekalan, karyawan where perbekalan.id_karyawan = karyawan.id_karyawan and karyawan.nik = ".$row->nik." and perbekalan.status = 'Available'")->num_rows(); echo $count;?></td>
                                                <td>
                                                <div align="center">
