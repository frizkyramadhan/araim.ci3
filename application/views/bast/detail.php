<!-- start: Content -->
			...
			<ul class="breadcrumb">
				...
				<li>
					<i class="icon-edit"></i>
					<a href="#">Detail Form Berita Acara Serah Terima</a>
				</li>
			</ul>
			<?php
			...
			<div class="row-fluid sortable">
				<div class="box span12">
					<div class="box-header" data-original-title>
						...
						<div class="box-icon">
							<a href="<?php echo site_url('bast/print_bast/'.$no_bast) ?>" target="_blank" onclick="return confirm('Are you sure to print this form? Press [Ctrl+P] to print the form')"><i class="halflings-icon white print"></i></a>
...
<!--                                                      <pre>
                                                      ...
                                                      <table class="table table-condensed">
                                                            <tr>
                                                                <td width="30%"><label><b>BAST No</b></label></td>
                                                                <td width="3%">:</td>
                                                                <td><?php echo $detail_row->no_reg;?></td>
                                                                <td><div align="right"><?php echo anchor('bast/edit_bast/'.$detail_row->no_bast, '&nbsp;Edit&nbsp;', array('class'=>'btn btn-success'));?></div></td>
                                                            </tr>
                                                            <tr>
                                                                <td><label><b>Date</b></label></td>
                                                                <td>:</td>
                                                                <td><?php echo $detail_row->date_bast;?></td>
                                                            </tr>
                                                        </table>
                                                        <table class="table table-condensed">
