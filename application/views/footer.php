	...
	<footer>
		<p>
			<span style="text-align:left;float:left">&copy; <?php echo date('Y');?> <a href="<?php echo base_url()?>" alt="Arkananta Asset Inventory Management">Arkananta Asset Inventory Management</a></span>	
		</p>
	</footer>
	...
	<!-- end: JavaScript-->
	<!--Created by: Frizky Ramadhan | frizkyramadhan@gmail.com | @frizkyramadhan-->
</body>
</html>