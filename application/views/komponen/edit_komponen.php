				...
				<form class="form-horizontal" role="form" action="" method="post">
					<fieldset>
						<div class="control-group">
							...
							<div class="controls">
								<input type="text" class="span6" name="komponen" value="<?php echo $komponen->komponen; ?>" />
							</div>
						</div>
						<div class="control-group">
							...
							<div class="controls">
								<select class="span6" id="selectError" data-rel="chosen" name="is_active">
									<option value="1" <?= $komponen->is_active == '1' ? ' selected="selected"' : ''; ?>>Active</option>
									<option value="0" <?= $komponen->is_active == '0' ? ' selected="selected"' : ''; ?>>Not Active</option>
								</select>
							</div>
						</div>
