...
<title>Form Berita Acara Peminjaman Barang #<?php echo $no_bapb; ?> - Arkananta Asset Inventory Management</title>
<style type="text/css">
...
<table width="100%" border="0" cellspacing="0" class="kop">
  <tr>
    ...
    <td width="137" style="border: #000000 solid 1px"><span class="style4">&nbsp; ARKA/ITY/IV/01.04</span></td>
  </tr>
  <tr>
  ...
  <tr>
    ...
    <td style="border: #000000 solid 1px"><span class="style4">&nbsp; 1-Jan-17</span></td>
  </tr>
  <tr>
...
<table width="100%" border="0" cellspacing="0" class="no">
  <tr>
    <td class="style2"><div align="center"><b>BERITA ACARA PEMINJAMAN BARANG</b></div></td>
  </tr>
  <tr>
...
<table width="100%" border="0" cellspacing="15" class="emp">
  <tr>
      <td><div align="justify">Barang-barang tersebut dipinjamkan selama <b><?php echo $detail_row->duration;?> hari</b> terhitung dari tanggal berita acara peminjaman barang ini dibuat. Barang tersebut dipinjamkan dalam keadaan baik dan diketahui oleh manager / pimpinan departemen yang bersangkutan. Barang di atas menjadi tanggung jawab departemen dan penerima, serta wajib menjaga dan merawat barang tersebut.</div></td>
  </tr>
</table>
<br><br><br><br>
