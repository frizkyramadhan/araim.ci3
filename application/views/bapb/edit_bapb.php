<!-- start: Content -->
			...
			<ul class="breadcrumb">
				...
				<li>
					<i class="icon-edit"></i>
					<a href="#">Edit Form Berita Acara Peminjaman Barang</a>
				</li>
			</ul>
			<?php
				...
				<div class="box span12">
					...
					<div class="box-content">
						  ...
						  <fieldset>
							  ...
							  <div class="controls">
                                                              <input name="date_bapb" class="span6 input-xlarge datepicker" placeholder="" value="<?php echo $detail_row->date_bapb; ?>"/>
							  </div>
							</div>
                                                      ...
                                                      <table class="table table-condensed">
														...
														<div class="control-group">
                                                            <label class="control-label"><b>Duration</b></label>
															  <div class="controls">
																<input name="duration" class="span6 input-xlarge" placeholder="Days" value="<?php echo $detail_row->duration; ?>"/>
															  </div>
														</div><br>
							<div class="control-group">
                                                            ...
                                                            <table class="table table-striped table-bordered table-condensed" style="font-size: 10pt">
                                                                ...
                                                                <tbody>
                                                                    <tr>
                                                                        ...
                                                                        <td><div align="center"><?php echo anchor('bapb/delete_row/'.$row->no_bapb.'/'.$row->id_bapb, 'Delete', array('class'=>'btn btn-mini btn-danger', 'onclick'=>"return confirm('Are you sure to delete this row?')"));?></div></td>
                                                                    </tr>
                                                                    <?php endforeach;?>
                                                                    <tr id="last">
                                                                        <td colspan="7"></td>
